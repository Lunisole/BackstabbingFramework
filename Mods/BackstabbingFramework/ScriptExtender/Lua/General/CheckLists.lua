...
Ext.Osiris.RegisterListener("StartedPreviewingSpell", 4, "before", function (entity,spell,_,_,_)
    if (Lu_BsF_SpellInList(spell,Lu_BsF_EnablingSpells) or Lu_BsF_PassiveInList(entity,Lu_BsF_EnablingPassives)) then
        Lu_BsF_BackstabbingInit(entity,spell)
    end
    if (Lu_BsF_SpellInList(spell,Lu_BsF_FlankingSpells) or Lu_BsF_PassiveInList(entity,Lu_BsF_FlankingPassives)) then
      Lu_BsF_FlankingInit(entity)
    end
end)
